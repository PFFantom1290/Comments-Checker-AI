...
export const en = {
  ...
  landing: {
    ...
    heroBody:
      "Paste any Amazon, eBay, Walmart, Best Buy, Rozetka or Comfy product link. Our AI reads the real customer reviews and gives you a clear Buy / Don't Buy verdict, pros and cons, a fake-review risk score, and a bottom-line recommendation — all in your language.",
    tryFree: "Try 3 scans free",
    howTitle: "How it works",
    how1Title: "1. Paste a product link",
    how1Body: "From Amazon, eBay, Walmart, Best Buy, Rozetka, Comfy, or most product pages with public reviews.",
    ...
    how3Body: "GPT-4o analyzes the reviews and returns a Buy / Don't Buy call, pros and cons, and a fake-review risk score.",
  ...
  billing: {
    ...
    title: "Buy more scans",
    youHave: "You currently have {n} scans available. Top up any time — purchased scans never expire.",
